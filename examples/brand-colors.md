...
Use this file to verify the MarkHola palette and table header styling in `v0.7.8`.
...
The table header should use the same Green Tint background in the Default, Dark, and Light app themes.
